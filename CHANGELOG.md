...
- **ai-update**: Now uses GitHub Releases API (was failing with tags-only)
  - Requires published GitHub releases (not just tags)

### Changed

- **GitHub CLI**: Added as recommended tool for creating releases
...
- **ai-config**: Fixed empty stub function overriding real implementation
  - Config display now shows all sections correctly (General, Providers, Routing, Preferences)
